(function () {
  ...
  const DEFAULT_PLAYERS = [
    ...
    { id: 2,  name: "Matas",    value: 25, rc: 0 },   // rc=0 -> NĖRA
  ...
  function onGateSubmit(e) {
    ...
    if (inputCode === codes.admin) {
      ...
      els.gateInput.value = "";
      els.gateInput.focus();
      setTimeout(() => { els.gateError.hidden = true; }, 2500);
    }
  }
  ...
  function updateManagerUI() {
    ...
    // Biudžetas
    if (currentUser.role === "admin") {
      // Admin mato viską – galėtume rodyti bendrą statistiką, bet paprastumo dėlei rodysime pirmo trenerio
    ...
    if (currentUser.role === "coach") {
      ...
      // Admin – rodyti visus žaidėjus rinkoje ir galbūt visas komandas
      els.myTeamTitle.textContent = "Visos komandos";
      // Supaprastinimas: rodome rinką su visais žaidėjais
      renderMarket([]);
  ...
  function renderTeamsDatalist() {
    ...
    // Pridėti keletą numatytų komandų, jei dar nėra
